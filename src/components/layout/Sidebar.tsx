...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 border-r border-slate-800 bg-slate-900 text-slate-100 flex flex-col h-screen sticky top-0 shrink-0 select-none shadow-xl">
      {/* Brand Header */}
      <div className="h-16 px-6 flex items-center border-b border-slate-800 justify-between">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          <div className="h-8 w-8 rounded-lg bg-purple-600 flex items-center justify-center text-white font-bold shadow-md">
            <Compass className="h-4 w-4" />
          </div>
          <span className="text-lg font-bold tracking-tight text-white">
            Path<span className="text-purple-400">AI</span>
          </span>
        </Link>
        <span className="px-2 py-0.5 text-[10px] font-bold text-purple-300 bg-purple-950/60 border border-purple-500/30 rounded-full uppercase tracking-wide">
          ML Demo
        </span>
      </div>

      {/* Career Goal Banner */}
      <div className="p-4 mx-3 my-3 rounded-xl bg-slate-950 border border-slate-800">
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-400 mt-2 pt-2 border-t border-slate-800">
          ...
          <span className="font-bold text-purple-400">8 mo plan</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-950/60">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-extrabold text-white">14 Day Streak 🔥</p>
            <p className="text-[10px] text-slate-400 font-medium">Top 5% Learner Consistency</p>
          </div>
        </div>
      </div>
    </aside>
