  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B1220] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans transition-colors">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Reset your password</h2>
          ...
          <CardContent className="pt-6 space-y-6">
            ...
            {isSubmitted ? (
              <div className="text-center py-4 space-y-4">
                <div className="h-12 w-12 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 mx-auto flex items-center justify-center border border-emerald-200 dark:border-emerald-500/30">
                ...
                <p className="text-xs text-slate-600 dark:text-[#CBD5E1]">
                  We sent a reset link to <strong className="text-slate-900 dark:text-white">{email}</strong> if an account exists.
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-center pt-2">
                  <Link href="/login" className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-600 dark:text-[#CBD5E1] hover:text-blue-600 dark:hover:text-blue-400">
