        ...
        <div className="border-b border-slate-200 pb-4 flex items-center justify-between flex-wrap gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Badge variant="primary" className="bg-orange-50 text-orange-700 border-orange-200">
                PathAI Assistant
              </Badge>
            ...
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Meet Buddy</h1>
          ...
          <div className="px-3.5 py-2 bg-slate-50 rounded-xl border border-slate-200 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-orange-100 text-orange-700">
              <Target className="h-4 w-4" />
            </div>
            <div className="text-xs">
              <div className="text-slate-400 text-[10px] font-bold uppercase tracking-wider">Current Focus</div>
              <div className="font-extrabold text-slate-900">{activeModule}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-3.5 border-slate-200 bg-white">
            <div className="flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-slate-900 mb-0.5">Rule-Based First</h4>
          ...
          <Card className="p-3.5 border-slate-200 bg-white">
            <div className="flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-slate-900 mb-0.5">Concise 1–4 Sentence Answers</h4>
                <p className="text-slate-500 leading-relaxed text-[11px]">
          ...
          <Card className="p-3.5 border-slate-200 bg-white">
            <div className="flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-slate-900 mb-0.5">20 AI Requests Daily</h4>
                <p className="text-slate-500 leading-relaxed text-[11px]">
